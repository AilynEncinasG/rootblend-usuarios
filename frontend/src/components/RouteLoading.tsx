...
function RouteLoadingIllustration() {
  return (
    ...
    >
      <circle cx="195" cy="152" r="110" fill="var(--rb-accent)" opacity="0.12" />
      ...
      <rect
        ...
        rx="34"
        fill="var(--rb-panel)"
        stroke="var(--rb-border-strong)"
        strokeWidth="5"
      />

      <path
        d="M130 124H260"
        stroke="var(--rb-muted-soft)"
        opacity="0.45"
        strokeWidth="8"
        strokeLinecap="round"
      />
      ...
      <circle cx="268" cy="114" r="12" fill="var(--rb-accent)" />
      <circle cx="246" cy="154" r="12" fill="var(--rb-danger)" />
      <circle cx="270" cy="184" r="12" fill="var(--rb-accent-2)" />
